...
Properties {
    _SideSgn("Internal side", Float) = 1.0
...
CGINCLUDE
	...
	{
		half3 worldNormal = PerPixelNormal(_BumpMap, i.bumpCoords, VERTEX_WORLD_NORMAL, PER_PIXEL_DISPLACE)*_SideSgn;
	...
	{
		half3 worldNormal = PerPixelNormal(_BumpMap, i.bumpCoords, half3(0,1,0), PER_PIXEL_DISPLACE)*_SideSgn;
		half3 viewVector = normalize(i.viewInterpolator.xyz);
