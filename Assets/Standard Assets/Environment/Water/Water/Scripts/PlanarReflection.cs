...
namespace UnityStandardAssets.Water
{
    ...
    public class PlanarReflection : MonoBehaviour
    {
        ...
        public String reflectionSampler = "_ReflectionTex", fresnelSide = "_SideSgn";
        ...
        void RenderReflectionFor(Camera cam, Camera reflectCamera)
        {
            ...
            float sideSign = Sgn(Vector3.Dot(cam.transform.position-reflectiveSurface.position,reflectiveSurface.up));
            m_SharedMaterial.SetFloat(fresnelSide, sideSign);

            Vector3 pos = reflectiveSurface.transform.position;
            pos.y = reflectiveSurface.position.y;
            Vector3 normal = reflectiveSurface.transform.up;
            float d = -Vector3.Dot(normal, pos) - clipPlaneOffset * sideSign;
            ...
            Vector4 clipPlane = CameraSpacePlane(reflectCamera, pos, normal, sideSign);
        ...
        {
            Vector3 offsetPos = pos + normal * clipPlaneOffset * sideSign;
